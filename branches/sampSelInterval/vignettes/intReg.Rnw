...
& = \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}} 
      \frac{\partial}{\partial \beta_i^S} \left[ \int_{z}^{{\vec{\beta}^S}' 
...
& = \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}} \left[
      ...
      \cdot \phi_2(a_1, {\vec{\beta}^S}' \vec{x}_i^S) 
      - \frac{\partial}{\partial \beta_i^S} (z) \cdot \phi(a_1, z)
      + \int_{z}^{{\vec{\beta}^S}' \vec{x}_i^S} \frac{\partial}{\partial \beta_i^S} \left( \phi_2(a_1, a_2) \right)
      \; d a_2
      \right] \; d a_1
\\
& = \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}} \left[
      \vec{x}_i^S \cdot \phi_2(a_1, {\vec{\beta}^S}' \vec{x}_i^S) 
      \right] \; d a_1
\\
& = \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}} \left[
      \phi_2(a_1, {\vec{\beta}^S}' \vec{x}_i^S) 
...
\pagebreak
Using equation this result we can now derive the gradient for $\beta_i^S$ in the log-likelihood function:
