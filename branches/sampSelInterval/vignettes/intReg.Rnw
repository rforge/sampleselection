...
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{1}{2\pi}
      \frac{\frac{\partial}{\partial \rho}[\exp \left( -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)] \cdot \sqrt{1-\rho^2} - \frac{\partial}{\partial \rho} [\sqrt{1-\rho^2}] \cdot \exp \left( -\frac{a_1       ^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)}{ 1 - \rho^2 }
   \; d a_1 \; d a_2 \nonumber \\ 
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{1}{2\pi}
      ...
      \right) \cdot \sqrt{1-\rho^2} - (-\frac{2\rho}{2 \sqrt{1-\rho^2}}] \cdot \exp \left( -\frac{a_1       ^2 - 2     \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)}{ 1 - \rho^2 }
   \; d a_1 \; d a_2 \nonumber \\ 
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{1}{2\pi}
      ...
      \right) \cdot \sqrt{1-\rho^2}}{1-\rho^2}  - (-\frac{2\rho}{2 \sqrt{1-\rho^2}}) \cdot \exp \left( -\frac{a_1       ^2 - 2     \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)}{ 1 - \rho^2 }
   \; d a_1 \; d a_2 \nonumber \\ 
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
