...
\section{Restricting coefficients $\rho$ and $\sigma_2^2$}
...
The parameter $\sigma_2$ needs to be strictly positive, i.e.~$\sigma_2 > 0$.
In order to restrict $\sigma_2$ to be strictly positive,
we estimate $\log( \sigma_2^2 )$ instead of $\sigma_2$ or $\sigma_2^2$
so that the derived parameters
$\sigma_2 = \sqrt{ \exp( \log( \sigma_2^2 ) ) }$
and $\sigma_2^2 = \exp( \log( \sigma_2^2 ) )$
are always strictly positive.
We use the delta method to calculate approximate standard errors
of the derived parameters~$\sigma_2$ and $\sigma_2^2$,
whereas the corresponding elements of the Jacobian matrix are:
\begin{align}
\frac{\partial \sqrt{ \exp( \log( \sigma_2^2 ) ) } }{
   \partial \log( \sigma_2^2 )}
= \frac{\partial \sigma_2 }{\partial \log( \sigma_2^2 )}
= \frac{\sigma_2 }{2}\\[3ex]
\frac{\partial \exp( \log( \sigma_2^2 ) )}{\partial \log( \sigma_2^2 )}
= \frac{\partial \sigma_2^2}{\partial \log( \sigma_2^2 )}
= \sigma_2^2
\end{align}
...
& \frac{\partial \Phi_2 \left( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}
    ...
    = \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      ...
      \vec{x}_i^O}{\sigma_2} \right) \cdot \left(-\frac{\vec{x}_i^O}{\sigma_2} \right)
\end{align}
...
& = \sum_{m=1}^M y_i^S ( y_i^O = m ) \cdot
   ...
   & \quad \left(
      ...
      \phi \left( \frac{ \alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}
         \right) \cdot
      \left( -\frac{ \vec{x}_i^O }{ \sigma_2 } \right) \right. \nonumber \\
   & \qquad \left. - \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
            + \rho \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}
         }{ \sqrt{1 - \rho^2} } \right)
      \phi \left( \frac{ \alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}
         \right) \cdot
      \left(-\frac{ \vec{x}_i^O }{ \sigma_2} \right) \right) \nonumber \\
& = \sum_{m=1}^M y_i^S ( y_i^O = m ) \cdot
        \frac{ 1 }{
   ...
   & \qquad \left. - \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      ...
      \phi \left( \frac{ \alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}
         \right)
      \right) \cdot
      \left( - \frac{ \vec{x}_i^O }{ \sigma_2} \right) \nonumber
\end{align}
...
\begin{align}
\frac{\partial \ell_i}{\partial \arctan(\rho)}
...
& = \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      + \rho \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}
      {\sqrt{1 - \rho^2}} \right) \phi \left( \frac{\alpha_{m} - {\vec{\beta}^O}' 
      \vec{x}_i^O}{\sigma_2} \right) \cdot \frac{{\vec{\beta}^O}' \vec{x}_i^O - 
      \alpha_{m}}{\sigma_2^2}
\end{align}
...
& = \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      ...
      {\sqrt{1 - \rho^2}} \right)
      \lim_{\alpha_m \rightarrow \infty}
      \frac{ \frac{{\vec{\beta}^O}' \vec{x}_i^O - \alpha_{m}}{\sigma_2^2} }{ 
         \left( \phi \left( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{
            \sigma_2} \right) \right)^{-1} } \\
& = \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      + \rho \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}
      {\sqrt{1 - \rho^2}} \right) \\
& \qquad \lim_{\alpha_m \rightarrow \infty}
      \frac{ - \frac{1}{\sigma_2^2} }{ 
         - \left( \phi \left(
               \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}
            \right) \right)^{-2} 
...
& = \sum_{m=1}^M y_i^S ( y_i^O = m )
      \frac{\frac{\partial \Phi_2 \left(
         ...
         - \frac{\partial \Phi_2 \left(
         \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) \Bigg)}{\partial \sigma_2}}
         {\Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) - \Phi_2 \left(
         \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
...
& = \sum_{m=1}^M \frac{y_i^S ( y_i^O = m )}{\Phi_2 \left(
   ...
   & \quad \left( 
    \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      ...
      \vec{x}_i^O}{\sigma_2} \right) \cdot \frac{{\vec{\beta}^O}' 
      \vec{x}_i^O - \alpha_{m+1}}{\sigma_2^2} \right. \nonumber \\
   & \qquad - \left. \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      + \rho \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}
      {\sqrt{1 - \rho^2}} \right) \phi \left( \frac{\alpha_{m} - {\vec{\beta}^O}' 
      \vec{x}_i^O}{\sigma_2} \right) \cdot \frac{{\vec{\beta}^O}' 
      \vec{x}_i^O - \alpha_{m}}{\sigma_2^2} \right) \nonumber
\end{align}

\begin{align}
\frac{\partial \ell_i}{\partial \log(\sigma_2^2)}
& = \frac{\partial \ell_i}{\partial \sigma_2}
   \frac{\partial \sigma_2}{\partial \log(\sigma_2^2)}
= \frac{\partial \ell_i}{\partial \sigma_2}
   \; \frac{\sigma_2}{2}
\end{align}
