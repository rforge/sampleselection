...
\subsection{Gradients with respect to the parameters in the self-selection decision ($\vec{\beta}^S$)}

First, we use equation \ref{eq:derivBivFinal}, to determine the derivative of the bivariate standard normal distribution with respect to the parameter $\vec{\beta}^S$ as part of the loglikelihood function. We use $z$ as variable for the lower boundary, with $\lim{z}_{z->-\infty}=-\infty$ :
...
& = \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}} \Bigg[
      \frac{\partial}{\partial \beta^S} \left( {\vec{\beta}^S}' \vec{x}_i^S \right)
      \cdot \phi_2(a_1, {\vec{\beta}^S}' \vec{x}_i^S, , -\rho) \\
      & \quad - \frac{\partial}{\partial \beta^S} (z) \cdot \phi_2(a_1, z, -\rho)
      + \int_{z}^{{\vec{\beta}^S}' \vec{x}_i^S} \frac{\partial}{\partial \beta^S} \left( \phi_2(a_1, a_2, , -\rho)
      \right)
      \; d a_2
      \Bigg] \; d a_1 \nonumber
\\
...
\pagebreak
Using this result we can now derive the gradient for $\vec{\beta}^S$ in the log-likelihood function:

\begin{align}
& \frac{\partial \ell_i}{\partial \beta^S} = \frac{\partial}{\partial \beta^S} \Bigg( ( 1 - y_i^S )
   \ln \left[ \Phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right) \right] \\
   ...
   \right] \Bigg) \nonumber \\
& = ( 1 - y_i^S )
   \frac{\partial}{\partial \beta^S} \Bigg( \ln \left[ \Phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right)               \right] \Bigg) \\
   & \quad + \sum_{m=1}^M y_i^S ( y_i^O = m ) \frac{\partial}{\partial \beta^S} \Bigg( \ln \left[
      \Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) \right. \nonumber \\
      & \qquad \left. - \Phi_2 \left(
...
\subsection{Gradients with respect to the parameters in the outcome decision ($\vec{\beta}^O$)}
...
& \frac{\partial \Phi_2 \left( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}, 
   ...
   = \frac{\partial}{\partial \beta^O} \left[ \int_{z}^{\frac{\alpha_{m} - 
      ...
      \vec{x}_i^S} \phi_2 \left( a_1, a_2, - \rho \right) \; d a_2 \; d a_1 \right]
\\
& = \frac{\partial}{\partial \beta^O} \left[ \int_{z}^{{\vec{\beta}^S}' \vec{x}_i^S}
...
& = \int_{z}^{{\vec{\beta}^S}' \vec{x}_i^S} \Bigg[
      \frac{\partial}{\partial \beta^O} \left( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} \right)
      \cdot \phi_2(\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}, a_2, -\rho) \\
         &  \quad - \frac{\partial}{\partial \beta^O} (z) \cdot \phi_2(z, a_2, -\rho)
         + \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}} \frac{\partial}{\partial \beta^O}
...
Using this result we derive the gradient for the outcome parameter $\vec{\beta}^O$ for the log-likelihood function:

\begin{align}
& \frac{\partial \ell_i}{\partial \beta^O} = \frac{\partial}{\partial \beta^O} \Bigg( ( 1 - y_i^S )
   \ln \left[ \Phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right) \right] \\
   & \quad + \sum_{m=1}^M y_i^S ( y_i^O = m ) \ln \left[
      \Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
      ...
      & \qquad \left. - \Phi_2 \left(
         ...
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) 
   \right] \Bigg) \nonumber \\
& = \sum_{m=1}^M y_i^S ( y_i^O = m ) \frac{\partial}{\partial \beta^O} \Bigg( \ln \left[
      \Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) \right. \\
      & \qquad \left. - \Phi_2 \left(
...
\subsection{Gradients with respect to the standard deviation used for normalisation ($\sigma_2$)}
\begin{align}
& \frac{\partial \Phi_2 \left( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}, 
      {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right)}{\partial \sigma_2} 
         = \frac{\partial}{\partial \sigma_2} \left[ \int_{z}^{{\vec{\beta}^S}' \vec{x}_i^S}
         \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}
         \phi_2 \left( a_1, a_2, - \rho \right) \; d a_1 \; d a_2 \right]
\\
& = \int_{z}^{{\vec{\beta}^S}' \vec{x}_i^S} \Bigg[
      \frac{\partial}{\partial \sigma_2} \left( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} \right)
      \cdot \phi_2(\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}, a_2, -\rho) \\
         &  \quad - \frac{\partial}{\partial \sigma_2} (z) \cdot \phi_2(z, a_2, -\rho)
         + \int_{z}^{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}} \frac{\partial}{\partial \sigma_2}
         \left( \phi_2(a_1, a_2, -\rho)
         \right)
         \; d a_1 \Bigg] \; d a_2 \nonumber
\\
& = \int_{z}^{{\vec{\beta}^S}' \vec{x}_i^S} \left[
      ...
      \right] \; d a_2 \cdot \frac{{\vec{\beta}^O}' \vec{x}_i^O - \alpha_{m}}{\sigma_2^2}
\\
& = \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      - \rho \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}{\sqrt{1 - \rho^2}} \right)
      \phi( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} ) 
      \cdot \frac{{\vec{\beta}^O}' \vec{x}_i^O - \alpha_{m}}{\sigma_2^2}
\end{align}

\begin{align}
& \frac{\partial \ell_i}{\partial \sigma_2} = \frac{\partial}{\partial \sigma_2} \Bigg( ( 1 - y_i^S )
   \ln \left[ \Phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right) \right] \\
   & \quad + \sum_{m=1}^M y_i^S ( y_i^O = m ) \ln \left[
      \Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
      ...
      & \qquad \left. - \Phi_2 \left(
         ...
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) 
   \right] \Bigg) \nonumber \\
& = \sum_{m=1}^M y_i^S ( y_i^O = m ) \frac{\partial}{\partial \sigma_2} \Bigg( \ln \left[
      \Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) \right. \\
      & \qquad \left. - \Phi_2 \left(
...
& = \sum_{m=1}^M y_i^S ( y_i^O = m )
      \frac{ \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      - \rho \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}{\sqrt{1 - \rho^2}} \right)
      \phi( \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} ) 
      \cdot \frac{{\vec{\beta}^O}' \vec{x}_i^O - \alpha_{m+1}}{\sigma_2^2}
         - \Phi \left( \frac{{\vec{\beta}^S}' \vec{x}_i^S 
      - \rho \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}{\sqrt{1 - \rho^2}} \right)
      \phi( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} ) 
      \cdot \frac{{\vec{\beta}^O}' \vec{x}_i^O - \alpha_{m}}{\sigma_2^2}}
