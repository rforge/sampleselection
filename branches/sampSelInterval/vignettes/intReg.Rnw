...
= \,  \frac{\partial \left[ \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \phi_2 ( a_1, a_2, \rho ) \; d a_1 \; d a_2 \right]}{\partial \rho}
...
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{\partial}{\partial \rho} \Bigg[
      \frac{\exp \left( -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)}{2 \pi \sqrt{ 1 - \rho^2 }} \Bigg]
   \; d a_1 \; d a_2 \nonumber \\
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{1}{2\pi}
   \frac{\partial}{\partial \rho} \Bigg[
      \frac{\exp \left( -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)}{\sqrt{ 1 - \rho^2 }} \Bigg]
   \; d a_1 \; d a_2 \nonumber \\
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{1}{2\pi}
      \frac{\frac{\partial}{\partial \rho}\Big[\exp \left( -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)\Big] \cdot \sqrt{1-\rho^2} - \frac{\partial}{\partial \rho} [\sqrt{1-\rho^2}] \cdot \exp \left(          -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)}{ 1 - \rho^2 }
   \; d a_1 \; d a_2 \nonumber \\ 
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{1}{2\pi}
      \frac{-\frac{1}{2}\frac{\partial}{\partial \rho}[\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}] \cdot       \exp \left( -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right) \cdot \sqrt{1-\rho^2}} { 1 - \rho^2 } \\
      & \qquad \qquad - \frac {(-\frac{2\rho}{2 \sqrt{1-\rho^2}}) \cdot \exp \left( -\frac{a_1^2 - 2\rho a_1 a_2 +     a_2^2}{2(1-\rho^2)}
      \right)}{ 1 - \rho^2 }
   \; d a_1 \; d a_2 \nonumber \\ 
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{1}{2\pi}
      \frac{-\frac{1}{2}\frac{-2 a_1 a_2 \cdot (1-\rho^2) - (-2\rho) \cdot (a_1^2 - 2\rho a_1 a_2 + a_2^2) \cdot       \exp \left( -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right) \cdot \sqrt{1-\rho^2}}{(1-\rho^2)^2}}{ 1 - \rho^2 } \\
      & \qquad \qquad - \frac{(-\frac{2\rho}{2 \sqrt{1-\rho^2}}) \cdot \exp \left( -\frac{a_1       ^2 - 2     \rho       a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right)}{ 1 - \rho^2 }
   \; d a_1 \; d a_2 \nonumber \\ 
= \, & \int_{- \infty}^{x_2} \int_{- \infty}^{x_1}
   \frac{-\frac{(2 \rho (-2 \rho a_1 a_2 + a_1^2 + a_2^2) - 2 a_1 a_2 (1-\rho^2)) \cdot \exp\left( -\frac{a_1^2 - 2    \rho a_1 a_2 + a_2^2}{2(1-\rho^2)}
      \right) }{2(1-\rho^2)^{\frac{3}{2}}}  + (\frac{\rho \exp \left( -\frac{a_1^2 - 2 \rho a_1 a_2 + a_2^2}{2(1         -\rho^2)}
      \right)}{\sqrt{1-\rho^2}}) }{2 \pi (1 - \rho^2) }
   \; d a_1 \; d a_2 \nonumber \\ 
\end{align}
...
Using equation \ref{eq:derivBivFinal}, we can now derive the gradient for $\beta_i^S$ in the log-likelihood function:
...
& = ( 1 - y_i^S )
    \frac{\phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right)}{\Phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right)}        \nonumber \\
   & \quad + \sum_{m=1}^M y_i^S ( y_i^O = m )
      \frac{ \Phi \left( \frac{\frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} - \rho \vec{\beta^S}' \vec{x}_i^S}{\sqrt{1 - \rho^2}} \right) \phi( \vec{\beta^S}' \vec{x}_i^S )
         -  \Phi \left( \frac{\frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} - \rho \vec{\beta^S}' \vec{x}_i^S}{\sqrt{1 - \rho^2}} \right) \phi( \vec{\beta^S}' \vec{x}_i^S )}
         {\Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) - \Phi_2 \left(
         \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
...
& = ( 1 - y_i^S )
    \frac{\phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right)}{\Phi \left( - {\vec{\beta}^S}' \vec{x}_i^S \right)}        \nonumber \\
   & \quad + \sum_{m=1}^M y_i^S ( y_i^O = m )
      \frac{ \Phi \left( \frac{\vec{\beta^S}' \vec{x}_i^S - \rho \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}{\sqrt{1 - \rho^2}} \right) \phi( \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} )
         -  \Phi \left( \frac{\vec{\beta^S}' \vec{x}_i^S - \rho \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2}}{\sqrt{1 - \rho^2}} \right) \phi( \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2} )}
         {\Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) - \Phi_2 \left(
         \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
...
& = \sum_{m=1}^M y_i^S ( y_i^O = m ) \frac{\partial}{\partial \rho} \Bigg( \ln \left[
   ...
   \right] \Bigg) \\
& = \sum_{m=1}^M y_i^S ( y_i^O = m )
      \frac{\frac{\partial}{\partial \rho} \Bigg( \phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) \Bigg)
         - \frac{\partial}{\partial \rho} \Bigg( \phi_2 \left(
         \frac{\alpha_{m} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
         {\vec{\beta}^S}' \vec{x}_i^S, - \rho \right) \Bigg)}
         {\Phi_2 \left(
         \frac{\alpha_{m+1} - {\vec{\beta}^O}' \vec{x}_i^O}{\sigma_2},
