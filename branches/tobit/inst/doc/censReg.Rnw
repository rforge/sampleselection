...
library( "censReg" )
@
The first argument of function \code{censReg} is \code{formula}.
...
The user interface of function \code{censReg} was inspired by
function \code{tobit} from the \pkg{AER} package
\citep{kleiber08a,r-aer-1.1}.
