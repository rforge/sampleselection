...
\usepackage{amsmath,amssymb,bbm,thumbpdf}
...
\author{Ott Toomet\\Tartu University
   \And Arne Henningsen\\University of Kiel}
...
\Month{July}
\Year{2008}
\Submitdate{2007-05-01}
\Acceptdate{2008-06-06}
...
at \url{http://CRAN.R-project.org/package=sampleSelection}.  The package implements two types
