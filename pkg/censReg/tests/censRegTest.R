...
margEff( estResult )
print.default( margEff( estResult ) )
...
print.default( margEff( estResultBhhh, returnJacobian = TRUE ) )
...
print.default( margEff( estResultBfgs, calcVCov = FALSE ) )
...
print( estResultNm )
margEff( estResultNm )
print.default( margEff( estResultNm ) )
...
print.default( margEff( estResultSann ) )
...
print.default( margEff( estResultStart ) )
...
print.default( margEff( estResultAdd ) )
...
print.default( margEff( estResultNeg, calcVCov = FALSE, returnJacobian = TRUE ) )
...
print.default( margEff( estResultAddNeg ) )
...
print.default( margEff( estResultBoth ) )
...
print.default( margEff( estResultEmpty ) )
